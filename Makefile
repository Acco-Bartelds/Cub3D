...
all: $(DIR_MLX) $(DIR_LIST)
	$(MAKE) $(NAME) -j4

$(DIR_MLX):
	git clone https://github.com/codam-coding-college/MLX42.git -o ca0f163 $(DIR_MLX)
...
allclean: mlxclean fclean lclean
...
.PHONY: all clean fclean lclean mlxclean allclean re echo run 
